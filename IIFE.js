...
(function titleCaps(array){
    ...
    // console.log(`Upper case array = ${caps}`);
    console.log("Upper case array =", caps);
})(arr);
...
(function removeDuplicates(arr){
    ...
    console.log("Array after removing Duplicates = ",temp);
})(array);
